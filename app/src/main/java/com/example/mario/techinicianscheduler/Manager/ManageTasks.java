...
/**
 * Manage the tasks held by manager.The tasks will be shown by a list.
 * The entrance to create,view and edit the tasks.
 */
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case 4:
                ...
                break;
            case 5:
                Intent intent4 = new Intent(ManageTasks.this, ManagerLogin.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
